...
class OptionSetConverter(BaseDHIS2Converter):
    ...
    @classmethod
    def to_optionsets_bundled(cls, objs, optiontSetName = "",  code = 'id', valueType = ValueType.text):
    ...
    @classmethod
    def to_optionsets_obj(cls, objs, optiontSetName = "",  valueType = ValueType.text, code = 'id'):
