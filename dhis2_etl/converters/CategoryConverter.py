...
from ..models.dhis2Metadata import Category, CategoryBundle, CategoryCombo, CategoryComboBundle, CategoryOption, CategoryOptionBundle
...
class CategoryConverter(BaseDHIS2Converter):
    ...
    @classmethod
    def to_categories_bundled(cls, objs, optiontSetName = "",  code = 'id', valueType = ValueType.text, **kwargs):
    ...
    @classmethod
    def to_categories_obj(cls, objs, optiontSetName = "",  valueType = ValueType.text, code = 'id', **kwargs):
    ...
    @classmethod
    def to_cat_obj(cls, option, optiontSetName = "",  att1 = "name", att2 = "",\
         code = 'id', **kwargs):
    ...
    @classmethod
    def to_cat_objs(cls, objs, optiontSetName = "",  att1 = "name", att2 = "",\
        code = 'id', **kwargs):   
        options = []
        for option in objs:
